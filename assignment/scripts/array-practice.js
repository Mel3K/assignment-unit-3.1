...
let favoriteFoods = ["tacos", "strawberries", "steak", "creme brulee"];
console.log('in my favoriteFoods array', favoriteFoods);
...
console.log('last animal in the animal array should be dog', lastAnimal);
...
indexOfLastAnimal = animalArray.length -1;
console.log('the index of the last animal is', indexOfLastAnimal );
...
let dessert = "strawberry pie";
favoriteFoods.push(dessert);
console.log('added a new dessert to end of favoriteFoods', favoriteFoods);
...
console.log('added an entree to the beginning of favoritefoods array', favoriteFoods, entree);
...
console.log('last color in color array', lastColor);
...
console.log('colors array is now', colors, "first color is ", firstColor);
